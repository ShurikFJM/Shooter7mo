...
public class TacticalHUD : MonoBehaviour
{
    ...
    void UpdateStatsDisplay()
    {
        ...
        {
            if (healthText != null) healthText.text = Mathf.CeilToInt(playerHealth.CurrentHealth.Value).ToString();
            if (armorText != null) armorText.text = Mathf.CeilToInt(playerHealth.CurrentArmor.Value).ToString();
        }
    }
